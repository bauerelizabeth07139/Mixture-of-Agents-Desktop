...
export type ModelType = 'llm' | 'tts' | 'image' | 'video' | '3d' | 'stt';
...
export interface UserPreferences {
  ...
  orchestratorThinkingMode: 'auto' | 'low' | 'medium' | 'high'; agentThinkingMode: 'auto' | 'low' | 'medium' | 'high'; maxConcurrentAgents: number; autoRetryOnFailure: boolean;
}
