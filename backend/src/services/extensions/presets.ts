...
export const MCP_PRESETS: McpPreset[] = [
  // === 工具类 ===
  {
    ...
    transport: 'stdio',
    command: 'pnpm',
    args: ['dlx', '@modelcontextprotocol/server-filesystem', process.platform === 'win32' ? process.env.TEMP || 'C:\\\\Temp' : '/tmp'],
    category: '工具',
    icon: '📂',
  ...
  },
  {
    ...
    transport: 'stdio',
    command: 'pnpm',
    args: ['dlx', 'mcp-server-github'],
    env: { GITHUB_PERSONAL_ACCESS_TOKEN: '' },
    category: '工具',
    icon: '🐙',
    npmPackage: 'mcp-server-github',
  },
  {
    id: 'fetch',
    name: 'Fetch',
  ...
  },
  {
    ...
    transport: 'stdio',
    command: 'pnpm',
    args: ['dlx', '@modelcontextprotocol/server-everything'],
    category: '测试',
    icon: '⭐',
  ...
  // === 数据库类 ===
  {
    ...
    transport: 'stdio',
    command: 'pnpm',
    args: ['dlx', 'mcp-server-sqlite', '--db-path', 'memory.db'],
    category: '数据库',
    icon: '🗃️',
  ...
  },
  {
    ...
    transport: 'stdio',
    command: 'pnpm',
    args: ['dlx', '@modelcontextprotocol/server-postgres'],
    env: { DATABASE_URL: '' },
    category: '数据库',
    icon: '🐘',
  ...
  },
  {
    ...
    transport: 'stdio',
    command: 'pnpm',
    args: ['dlx', '@benborla29/mcp-server-mysql'],
  ...
  },
  {
    ...
    transport: 'stdio',
    command: 'pnpm',
    args: ['dlx', '@modelcontextprotocol/server-redis'],
  ...
  // === 浏览器类 ===
  {
    ...
    transport: 'stdio',
    command: 'pnpm',
    args: ['dlx', '@modelcontextprotocol/server-puppeteer'],
    category: '浏览器',
    icon: '🎭',
  ...
  },
  {
    ...
    transport: 'stdio',
    command: 'pnpm',
    args: ['dlx', '@anthropic/notion-mcp-server@latest'],
    env: { NOTION_API_KEY: '' },
    category: '协作',
    icon: '📝',
  ...
  },
  {
    ...
    transport: 'stdio',
    command: 'pnpm',
    args: ['dlx', '@anthropic/slack-mcp-server@latest'],
  ...
  },
  {
    ...
    transport: 'stdio',
    command: 'pnpm',
    args: ['dlx', '@anthropic/google-drive-mcp-server@latest'],
  ...
  // === 设计/媒体 ===
  {
    ...
    transport: 'stdio',
    command: 'pnpm',
    args: ['dlx', '@anthropic/figma-mcp-server@latest'],
  ...
  // === 云服务 ===
  {
    ...
    transport: 'stdio',
    command: 'pnpm',
    args: ['dlx', '@anthropic/aws-mcp-server@latest'],
  ...
  },
  {
    ...
    transport: 'stdio',
    command: 'pnpm',
    args: ['dlx', '@anthropic/docker-mcp-server@latest'],
    category: '云服务',
    icon: '🐳',
  ...
  // === 安全/监控 ===
  {
    ...
    transport: 'stdio',
    command: 'pnpm',
    args: ['dlx', '@anthropic/sentry-mcp-server@latest'],
  ...
  // === 专用模型 ===
  {
    ...
    transport: 'stdio',
    command: 'pnpm',
    args: ['dlx', '@anthropic/elevenlabs-mcp-server@latest'],
...
export const SKILL_SERVER_PRESETS: SkillServerPreset[] = [
  // === 官方 Skill Servers ===
  {
    ...
    transport: 'stdio',
    command: 'pnpm',
    args: ['dlx', '@anthropic/claude-skills@latest'],
    category: '官方',
    icon: '🤖',
  ...
  },
  {
    ...
    transport: 'stdio',
    command: 'pnpm',
    args: ['dlx', 'openai-agents-mcp@latest'],
    category: '官方',
    icon: '🧠',
  ...
  // === 代码分析类 ===
  {
    ...
    transport: 'stdio',
    command: 'pnpm',
    args: ['dlx', '@anthropic/ast-grep-mcp@latest'],
    category: '代码分析',
    icon: '🌳',
  ...
  },
  {
    ...
    transport: 'stdio',
    command: 'pnpm',
    args: ['dlx', 'tree-sitter-mcp@latest'],
    category: '代码分析',
    icon: '🌲',
  ...
  },
  {
    ...
    transport: 'stdio',
    command: 'pnpm',
    args: ['dlx', 'excel-mcp-server@latest'],
    category: '数据',
    icon: '📗',
  ...
  },
  {
    ...
    transport: 'stdio',
    command: 'pnpm',
    args: ['dlx', 'pdf-mcp-server@latest'],
    category: '数据',
    icon: '📕',
  ...
  },
  {
    ...
    transport: 'stdio',
    command: 'pnpm',
    args: ['dlx', 'rag-mcp-server@latest'],
    category: 'AI',
    icon: '📚',
  ...
  // === 图像/媒体处理 ===
  {
    ...
    transport: 'stdio',
    command: 'pnpm',
    args: ['dlx', 'image-mcp-server@latest'],
    category: '媒体',
    icon: '🖼️',
  ...
  },
  {
    ...
    transport: 'stdio',
    command: 'pnpm',
    args: ['dlx', 'video-mcp-server@latest'],
    category: '媒体',
    icon: '🎬',
  ...
  // === 通知/通讯 ===
  {
    ...
    transport: 'stdio',
    command: 'pnpm',
    args: ['dlx', 'email-mcp-server@latest'],
  ...
  },
  {
    ...
    transport: 'stdio',
    command: 'pnpm',
    args: ['dlx', 'telegram-mcp-server@latest'],
  ...
  },
  {
    ...
    transport: 'stdio',
    command: 'pnpm',
    args: ['dlx', 'discord-mcp-server@latest'],
